...
Public Class crptTardiness
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HR_System.crptTardiness.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrptTardiness
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptTardiness = New crptTardiness()
        rpt.Site = Me.Site
        Return rpt
    End Function
