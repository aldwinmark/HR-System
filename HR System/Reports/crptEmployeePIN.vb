...
Public Class crptEmployeePIN
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HR_System.crptEmployeePIN.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrptEmployeePIN
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptEmployeePIN = New crptEmployeePIN()
        rpt.Site = Me.Site
        Return rpt
    End Function
